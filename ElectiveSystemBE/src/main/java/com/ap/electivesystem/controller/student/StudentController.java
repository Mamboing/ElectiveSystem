...
public class StudentController {
    ...
    public ResultVO list(@RequestParam String courseName, @RequestParam String courseTime, @RequestParam String teacherName, @RequestParam(defaultValue = "20") int pageSize, @RequestParam(defaultValue = "1") int pageNo) {
